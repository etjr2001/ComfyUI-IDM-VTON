...
class IDM_VTON_V2:
    ...
    def make_inference(self, pipeline, human_img, garment_img, pose_img, mask_img, height, width, garment_description, negative_prompt, num_inference_steps, strength, guidance_scale, seed):
        ...
        original_human_image = human_img.copy()

        original_width, original_heigth = human_img.size
        ...
        with torch.no_grad():
            ...
            with torch.cuda.amp.autocast():
                with torch.inference_mode():
                    ...
                    images = [image.resize((original_width, original_heigth)) for image in images]
                    images.append(original_human_image)
